...
import frc.robot.TempConstants.SwerveModuleConstants;
...
public class SwerveModule {
         ...
         */
        public SwerveModule(int drivingCANId, int turningCANId, int turningAnalogPort, double encoderOffset,
                        boolean drivingInverted, boolean turningInverted,
                        SwerveConfig config) {
                ...
                m_turningAbsoluteEncoder.setPositionOffset(encoderOffset);
        ...
        public void resetEncoders() {
                ...
                m_turningEncoder.setPosition(m_turningAbsoluteEncoder.getVirtualPosition()); // set relative position
                                                                                             // based on
                                                                                             // virtual absolute
                                                                                             // position
        }
